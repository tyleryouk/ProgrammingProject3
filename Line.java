...
public class Line {
  ...
  public String toString(){
    double vx=this.p2.getX()-this.p1.getX();
    double vy=this.p2.getY()-this.p1.getY();
    double vz=this.p2.getZ()-this.p1.getZ();
    //three parametric equations for the line
    String ret="";
    ret+="x="+this.p1.getX();
    if(vx<0){ret+=vx+"t";}
    else{ret+="+"+vx+"t";}
    ret+=" , "; //space in between so it's easier to read
    ret+="y="+this.p1.getY();
    if(vy<0){ret+=vy+"t";}
    else{ret+="+"+vy+"t";}
    ret+=" , ";
  ...
  /**equals method for all possible parameters (combinations of Line and Line2D)*/
  ...
  /**isParallel method for all possible parameters (combinations of Line and Line2D)*/
  ...
  /**intersection method for all possible parameters (combinations of Line&Line, and Line2D&Line2D)*/ 
